...
/*
 Wrapper = 감싸다
 	...
 	기본으로 제공하주는 int, double, char, short, long, boolean, float, byte
...
public class WrapperEx {
	public static void main(String[] args) {
		...
		System.out.println("인테져 값 : " + 인테져값);
		System.out.println("기본인테져 값 : " + 기본인테져값);
		
		// Long
		Long 롱값 = 40L;
		long 기존롱값 = 롱값.longValue();
		System.out.println("롱 값 : " + 롱값);
		System.out.println("기존롱 값 : " + 기존롱값);
		
		// Float
		Float 플롯값 = 50.5f;
		float 기존플롯값 = 플롯값.floatValue();
		System.out.println("플롯 값 : " + 플롯값);
		System.out.println("기존플롯 값 : " + 기존플롯값);
		
		// Double
		Double 더블값 = 60.6;
		double 기존더블값 = 더블값.doubleValue();
		System.out.println("더블 값 : " + 더블값);
		System.out.println("기존더블 값 : " + 기존더블값);
		
		// Character
		Character 캐릭터값 = 'A';
		char 기존캐릭터값 = 캐릭터값.charValue();
		System.out.println("캐릭터 값 : " + 캐릭터값);
		System.out.println("기존캐릭터 값 : " + 기존캐릭터값);
		
		// Boolean
		Boolean 불리언값 = true;
		boolean 기존불리언값 = 불리언값.booleanValue();
		System.out.println("불리언 값 : " + 불리언값);
		System.out.println("기존불리언 값 : " + 기존불리언값);
