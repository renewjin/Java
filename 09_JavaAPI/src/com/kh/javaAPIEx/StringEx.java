...
public class StringEx {
	...
	public static void main(String[] args) {
		...
		// Garbage 쓰레기 -> 사용되지 않아 그럼 필요가 없음 -> 버림!
		String phone = "010";
		phone += "1234-5678";
		...
		// 1. subString()
		String 서브스트링 = 문자열.substring(5);
		System.out.println(서브스트링);
		String 서브스트링1 = 문자열.substring(6,8); // 인덱스가 6부터 7까지 보여준다는 의미
		...
		// 7. charAt 문자열에서 주어진 인덱스에 행당하는 문자 하나를 반환
