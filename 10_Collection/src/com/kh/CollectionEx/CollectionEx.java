...
/*
 ...
 sort = 리스트를 기본 정렬 순서에 따라 정렬
 	...
 	3. 우리가 파일을 만들어서 정한 기준 : compareTo() 메서드를 활용해서 정렬 기준을 작성할 수 있음
 min, max = 리스트안의 최소값, 최대값
...
public class CollectionEx {
	public static void main(String[] args) {
		...
		// Collection을 이용해서 오름차순으로 정렬하기
		Collections.sort(숫자들);
		System.out.println(숫자들);
		System.out.println(Collections.min(숫자들));
		System.out.println(Collections.max(숫자들));
		System.out.println(Collections.binarySearch(숫자들, 5));
