...
/*
 ...
 previous는 뒤에서부터
 hasPrevious() : 이전 값이 존재하는 true, false로 확인
 previous() : 이전 값 가져오기
 
 ListIterator는 값을 추가하거나 삭제할 수 있음
 add() : 추가
 remove() : 삭제
 */
public class ListIteratorEx {
	public static void main(String[] args) {
		...
		//next()나 previous() 사용해서 현재 위치를 노랑의 위치로 이동
		반복하기.previous();
		반복하기.remove();
		...
		at com.kh.IteratorEx.ListIteratorEx.main(ListIteratorEx.java:50)
		...
		해결하는 방법
			...
			pervious()를 호출해서 현재 위치를 변경한 다음에 remove() 호출
		 */
