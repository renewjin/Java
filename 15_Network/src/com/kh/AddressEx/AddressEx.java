...
/*
 ...
 타인의 컴퓨터나 도메인, 또는 특정위치에 들어갈 수 있는 번호 2자리 또는 4자리
 
 InetAddress : Java에서 IP 주소를 나타내는데 사용
 	호스트명과 IP주소간의 변화, 집주인에 대한 정보 검색 등을 가능하게 해줌
 ...
 영어로된 이름 주소와 숫자로 된 주소가 다른사람이 검색했을 경우와 내가 검색했을 때 숫자가 주소가
...
public class AddressEx {
	...
	public static void main(String[] args) {
		...
		} catch (UnknownHostException e) { //시도했을 때 예외가 발생하면 보일
